...
(function() {
    ...
    midiBridge.init = function () {
        ...
        function browserNotSupported(browser,alternatives){
            console.log( browser + " is not supported with MIDI plugin.  Please use " + alternatives );            
        }
        ...
        if (!navigator.javaEnabled()) {
            if (onError)
                onError("No java plugin found; install or enable the java plugin for MIDI support");
            console.log("no java plugin found; install or enable the java plugin for MIDI support");
            return;
        }
